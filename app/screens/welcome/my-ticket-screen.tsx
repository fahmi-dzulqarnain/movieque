...
export const MyTicketScreen = observer(function MyTicketScreen() {
  ...
  // fetch('https://tesuto.vkp.co.id/api/ticket/create', params).then(() => {})
  ...
  _postData
  return (
    <View testID="MyTicketScreen" style={styles.full}>
      <Screen preset="fixed" backgroundColor={palette.orangeDarker}>
        <Header 
          headerTx="myTicket.title" 
          leftIcon="back24"
          style={styles.header}
